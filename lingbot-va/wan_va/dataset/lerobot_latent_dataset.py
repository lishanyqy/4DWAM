...
class LatentLeRobotDataset(LeRobotDataset):
    ...
    def __getitem__(self, idx) -> dict:
        ...
        out_dict['actions'], out_dict['actions_mask'] = self._action_post_process_eef14_raw_new(local_start_frame, latent_frame_ids, ori_data_dict['action'])
        # out_dict['actions'], out_dict['actions_mask'] = self._action_post_process_new(local_start_frame, latent_frame_ids, ori_data_dict['action'])
