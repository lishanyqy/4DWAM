...
va_robotwin_train_cfg.resume_from = os.path.join('/data/lingbot/ckpt/va_4_16_50000/checkpoints/checkpoint_step_1500/')
...
va_robotwin_train_cfg.save_root = f'/data/lingbot/ckpt_resume_va_1500/ta_{int(64/va_robotwin_train_cfg.gradient_accumulation_steps)}_{va_robotwin_train_cfg.gradient_accumulation_steps}_50000'
# others
