...
# va_robotwin_train_cfg.personal_model_path = '/data/lingbot/ckpt/64_50000/checkpoints/'
va_robotwin_train_cfg.personal_model_path = '/data/lingbot/ckpt_resume_va_1500/ta_8_8_50000/checkpoints'
va_robotwin_train_cfg.data_path = '/data/.cache/datasets/lerobot/robotwin/'
va_robotwin_train_cfg.dataset_path = os.path.join(va_robotwin_train_cfg.data_path, 'tiny')
...
# va_robotwin_train_cfg.wan22_pretrained_model_name_or_path = os.path.join(va_robotwin_train_cfg.personal_model_path, 'modelscope/hub/models/robbyant/lingbot-va-base/')
va_robotwin_train_cfg.wan22_pretrained_model_name_or_path = os.path.join(va_robotwin_train_cfg.personal_model_path, 'checkpoint_step_1000/')
va_robotwin_train_cfg.vae_path = os.path.join(va_robotwin_train_cfg.cache_path, 'modelscope/hub/models/robbyant/lingbot-va-base/')
va_robotwin_train_cfg.text_model_path = os.path.join(va_robotwin_train_cfg.cache_path, 'modelscope/hub/models/robbyant/lingbot-va-base/')
...
va_robotwin_train_cfg.save_root = './train_out'
