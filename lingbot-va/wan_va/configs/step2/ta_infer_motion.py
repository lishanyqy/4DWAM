...
va_robotwin_train_cfg.personal_model_path = '/data/lingbot/motion_align/va_4_16_50000/checkpoints'
...
va_robotwin_train_cfg.wan22_pretrained_model_name_or_path = os.path.join(va_robotwin_train_cfg.personal_model_path, 'checkpoint_step_2000/')
