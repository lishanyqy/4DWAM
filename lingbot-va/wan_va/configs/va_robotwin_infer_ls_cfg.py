...
va_robotwin_train_cfg.personal_model_path = '/root/workspace/lishan/lingbot-va'
...
va_robotwin_train_cfg.wan22_pretrained_model_name_or_path = os.path.join(va_robotwin_train_cfg.personal_model_path, 'train_out/checkpoints/checkpoint_step_3000/')
