...
va_robotwin_train_cfg.dataset_path = os.path.join(va_robotwin_train_cfg.data_path, 'comp_trace/robotwin_ds/lerobot_robotwin_eef_clean_50/')
...
va_robotwin_train_cfg.keyword = f'unified_dest_motion_{va_robotwin_train_cfg.align_layer}'
