...
lingbot4dwam_train_cfg.data_path = f"{os.environ['HOME']}/dataspace"
lingbot4dwam_train_cfg.model_path = f"{os.environ['HOME']}/modelspace"
lingbot4dwam_train_cfg.dataset_path = os.path.join(lingbot4dwam_train_cfg.data_path, 'lerobot_robotwin_eef_clean_50/')
...
lingbot4dwam_train_cfg.wan22_pretrained_model_name_or_path = os.path.join(lingbot4dwam_train_cfg.model_path, 'modelscope/hub/models/robbyant/lingbot-va-base/')
# if resume
