...
lingbot4dwam_train_cfg.__name__ = 'Config: VA Lift2 long-episode test train'

lingbot4dwam_train_cfg.dataset_path = os.path.join(
    lingbot4dwam_train_cfg.data_path,
    'lift2_long185_test_step3_compatible_60hz',
)
...
# A few optimizer steps are sufficient to determine whether one F=185 sample
# can complete forward, backward, and optimizer state initialization.
lingbot4dwam_train_cfg.num_steps = 3
lingbot4dwam_train_cfg.enable_wandb = False
lingbot4dwam_train_cfg.keyword = (
    f'lift2_long185_test_4DWAM_{lingbot4dwam_train_cfg.align_layer}'
)
