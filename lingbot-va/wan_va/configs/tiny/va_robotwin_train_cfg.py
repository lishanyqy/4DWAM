...
va_robotwin_train_cfg.load_worker = 12
...
va_robotwin_train_cfg.resume_from = os.path.join('/root/workspace/lishan/lingbot-va/train_out/checkpoints/checkpoint_step_3000/')
...
va_robotwin_train_cfg.save_root = '/data/lingbot/ckpt/32_50000'
# others
