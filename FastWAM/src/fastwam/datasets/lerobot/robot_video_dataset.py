...
class RobotVideoDataset(torch.utils.data.Dataset):
    def __init__(
        ...
        self.return_trace_video = bool(return_trace_video)
    ...
    def _get(self, idx):
        ...
        if video.ndim == 5:
            ...
            if self.return_trace_video:
                trace_video = video.clone()
            ...
            if self.return_trace_video:
                trace_video = video.unsqueeze(0).clone()
