...
def _resolve_configs(
    ...
    vae_config = (
        ...
        else ModelConfig(model_id=model_id, origin_file_pattern="Wan2.2_VAE.pth")
    )
    tokenizer_config = ModelConfig(model_id=tokenizer_model_id, origin_file_pattern="google/umt5-xxl/")

    if redirect_common_files and vae_path is None:
        redirect_dict = {
    ...
    elif redirect_common_files:
        text_config.model_id, text_config.origin_file_pattern = (
